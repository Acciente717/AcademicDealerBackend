"""
Django settings for AcademicDealerBackend project.
...
SECRET_KEY = '4hlj0k&w@61qwd#i46q-u*2n=76c3e(@j!()9z17(xbpug$fmu'
...
ROOT_URLCONF = 'AcademicDealerBackend.urls'
...
WSGI_APPLICATION = 'AcademicDealerBackend.wsgi.application'
